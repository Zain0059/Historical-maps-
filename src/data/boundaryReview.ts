...
export function getReviewedSlide(slide: SlideData, phaseId?: string): SlideData {
 ...
 if (phase) return {...slide,headline:slide.id===21?'مصر: الحدود والسيطرة والمناطق المختلف عليها':slide.headline,capital:phase.capital,boundaryReview:review,boundaryPhase:phase,reconstructionDate:phase.label,text:`<p>${phase.summary}</p>`,borderDescription:phase.limitations,extent:{core:[],controlFeatures:phase.features},keyEvents:undefined,frontierCities:undefined,geographicalStats:undefined,sources:undefined};
